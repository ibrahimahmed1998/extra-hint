...
Route::group(
    ['middleware' => 'api', 'prefix' => 'Student'],function ($router) {
        ...
        Route::post('SCT', Student_Area::class . '@SCT')->middleware(admin_::class);
    }
);

Route::group(
    ['middleware' => admin_::class, 'prefix' => 'admin'],function ($router) {
...
Route::group(
    ['middleware' => 'api', 'prefix' => 'chat'],function ($router) {
