...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img 
            {{-- style="opacity:0.5"  --}}
            class="d-block w-100" src="{{ asset('/image/ASU-Cairo-min.jpg') }}" alt="First slide">
        ...
        <div class="carousel-item">
            <img 
            {{-- style="opacity:0.5" --}}
             class="d-block w-100" src="{{ asset('/image/ain2-min.jpg') }}" alt="Second slide">
            <div class="carousel-caption d-none d-md-block">
        ...
        <div class="carousel-item">
            <img 
            {{-- style="opacity:0.5" --}}
             class="d-block w-100" src="{{ asset('/image/ain1-min.jpg') }}" alt="Third slide">
            <div class="carousel-caption d-none d-md-block">
